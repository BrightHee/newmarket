...
import com.newmarket.modules.area.CityProvince;
...
import com.newmarket.modules.garment.validator.ChatPartnerFormValidator;
import com.newmarket.modules.garment.validator.ChatRoomFormValidator;
import com.newmarket.modules.garment.validator.DetailSearchFormValidator;
import com.newmarket.modules.garment.validator.GarmentFormValidator;
...
public class GarmentController {
    ...
    public String showDetails(@PathVariable Long id, Model model, @AuthenticatedAccount Account account) {
        ...
        if (account.equals(garment.getAccount())) {
            model.addAttribute("chatRoomPartnerList", garment.getChatRoomPartners());
        }
